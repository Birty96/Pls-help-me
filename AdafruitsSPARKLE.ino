...
void groupSparkle(byte, byte, byte, unsigned long, unsigned long);
...
groupSparkle(255, 255, 255, 3, 80, 10000);

fillRange(0, 24, 255, 0, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(25, 49, 0, 255, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(50, 74, 255, 255, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(75, 99, 0, 0, 255);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(100, 124, 255, 0, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(125, 149, 0, 255, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(150, 174, 255, 255, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(175, 199, 0, 0, 255);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(200, 224, 255, 0, 0);
delay(500);
setAll(0,0,0);
strip.show();
fillRange(225, 256, 0, 255, 0);
delay(500);
setAll(0,0,0);
strip.show();
...
void fillRange(int startPixel, int endPixel, byte r, byte g, byte b) {
  if (startPixel > endPixel) {
    Serial.println("Argument Error: startPixel cannot be lower than endPixel");
    exit(1);
  }
...
/**
   Sparkle a random pixel for `wait` ms for `n` ms
*/
void groupSparkle(byte r, byte g, byte b, int width, unsigned long wait, unsigned long n) {
  unsigned long startTime = millis();

  while (startTime + n > millis())
  {
    int pixel = random(NUM_LEDS);
    Serial.print("Random sparkle position: ");
    Serial.println(pixel);
    setPixel(pixel, r, g, b);
    for(int i = 1; i <= width; i++)
    {
      setPixel(pixel-i, r, g, b);
      setPixel(pixel+i, r, g, b);
    }
...
void FadeInOut(byte red, byte green, byte blue, unsigned long wait, unsigned long n) {
  float r, g, b;
  unsigned long startTime = millis();
